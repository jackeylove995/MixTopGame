...
namespace XLua.CSObjectWrap
{
    ...
    public class ZLuaFrameworkLuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ZLuaFramework.LuaBehaviour);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ZLuaFramework.LuaBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ZLuaFramework.LuaBehaviour constructor!");
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                ZLuaFramework.LuaBehaviour gen_to_be_invoked = (ZLuaFramework.LuaBehaviour)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                ZLuaFramework.LuaBehaviour gen_to_be_invoked = (ZLuaFramework.LuaBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (ZLuaFramework.Injection[])translator.GetObject(L, 2, typeof(ZLuaFramework.Injection[]));
