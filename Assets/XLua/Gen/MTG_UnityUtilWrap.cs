...
namespace XLua.CSObjectWrap
{
    ...
    public class MTGUnityUtilWrap 
    {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LocalMove_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    MTG.UnityUtil.LocalMove( _transform, _x, _y, _z );
        ...
        static int _m_SetLocalPosition_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Transform>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    MTG.UnityUtil.SetLocalPosition( _transform, _x, _y );
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Transform>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    MTG.UnityUtil.SetLocalPosition( _transform, _x, _y, _z );
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Transform>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    ...
                    MTG.UnityUtil.SetLocalPosition( _transform, _pos );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MTG.UnityUtil.SetLocalPosition!");
        ...
        static int _m_SetPosition_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    MTG.UnityUtil.SetPosition( _transform, _x, _y, _z );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetLocalZ_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    MTG.UnityUtil.SetLocalZ( _transform, _z );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetZ_xlua_st_(RealStatePtr L)
        {
		    try {
